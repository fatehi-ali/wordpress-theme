...
function wpdocs_kantbtrue_init() {
    $labels = array(
        'name'                  => _x( 'کتاب', 'Post type general name', 'recipe' ),
        'singular_name'         => _x( 'کتاب', 'Post type singular name', 'recipe' ),
        'menu_name'             => _x( 'کتاب', 'Admin Menu text', 'recipe' ),
        'name_admin_bar'        => _x( 'کتاب', 'Add New on Toolbar', 'recipe' ),
        'add_new'               => __( 'افزودن', 'recipe' ),
        'add_new_item'          => __( 'افزودن کتاب', 'recipe' ),
        'new_item'              => __( 'New recipe', 'recipe' ),
        'edit_item'             => __( 'Edit recipe', 'recipe' ),
        'view_item'             => __( 'View recipe', 'recipe' ),
        'all_items'             => __( 'همه کتاب ها', 'recipe' ),
        'search_items'          => __( 'Search recipes', 'recipe' ),
        'parent_item_colon'     => __( 'Parent recipes:', 'recipe' ),
        'not_found'             => __( 'کتابی موجود نیست.', 'recipe' ),
        'not_found_in_trash'    => __( 'کتابی در سطل زباله یافت نشد.', 'recipe' ),
        'featured_image'        => _x( 'تصویر شاخص', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'recipe' ),
    ...
    $args = array(
        ...
        'hierarchical'       => false,
        'menu_position'      => 20,
        'supports'           => array( 'title', 'editor', 'author', 'thumbnail','post_tag' ),
